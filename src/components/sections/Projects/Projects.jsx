    ...
    <article className="bg-[#111111] rounded-lg border border-gray-800 p-6 hover:border-gray-700 transition-all duration-300 group">
      ...
      <div className="flex items-start justify-between mb-4">
        <div className="flex-1 min-w-0">
          <h3
            className={`text-xl font-semibold mb-2 group-hover:text-blue-400 transition-colors break-words ${
  ...
  useEffect(() => {
    const fetchGitHubProjects = async () => {
      ...
      const CACHE_KEY = GITHUB_TOKEN
        ? "github_projects_cache_auth"
        : "github_projects_cache_public";
  ...
  return (
    <section id="projects" className="py-16">
      <div className="max-w-3xl px-4 mx-auto">
        <div className="mb-12">
          <h2 className="mb-2 text-3xl font-semibold text-white">Projects</h2>
            ...
            {hasMoreProjects && (
              <div className="flex justify-center mt-12">
                <button
                  ...
                  className="flex items-center gap-2 px-8 py-3 text-gray-300 transition-colors border border-gray-700 rounded-lg hover:bg-gray-800 hover:border-gray-600"
                >
